...
:END:
** Lead Software Developer at [[https://www.evolution.com][Evolution]]
:PROPERTIES:
:CUSTOM_ID: evolution
:END:
*** Jun 2019 - Present
Writing and maintaining games. Arsenal: Scala, Cats, Akka Cluster, Kafka,
Cassandra.
...
:END:
*** Apr 2018 - Jun 2019
Worked on [[#tox-rs][tox-rs]] (see projects).
...
** [[https://github.com/pointsgame/oppai-rs][OpPAI]]
:PROPERTIES:
:CUSTOM_ID: oppai
:END:
*** Rust
Artificial intelligence for the game of Points. It uses various techniques
of game theory and computer science.
